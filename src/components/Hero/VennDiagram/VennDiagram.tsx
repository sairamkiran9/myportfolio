  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none" style={{ zIndex: 0 }}>
      <svg width="700" height="500" viewBox="0 0 700 500" className="opacity-20">
        ...
        {/* Labels */}
        <text x="200" y="120" fontFamily="sans-serif" fontSize="18" fill="white" opacity="0.9" textAnchor="middle">Backend</text>
        <text x="490" y="120" fontFamily="sans-serif" fontSize="18" fill="white" opacity="0.9" textAnchor="middle">Event Driven</text>
